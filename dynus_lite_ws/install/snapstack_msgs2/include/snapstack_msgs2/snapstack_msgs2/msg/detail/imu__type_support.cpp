...
{
  new (message_memory) snapstack_msgs2::msg::IMU(_init);
}

void IMU_fini_function(void * message_memory)
{
  auto typed_message = static_cast<snapstack_msgs2::msg::IMU *>(message_memory);
  typed_message->~IMU();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IMU_message_member_array[5] = {
  {
    ...
    offsetof(snapstack_msgs2::msg::IMU, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(snapstack_msgs2::msg::IMU, imu_stamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(snapstack_msgs2::msg::IMU, gyro),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(snapstack_msgs2::msg::IMU, accel),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(snapstack_msgs2::msg::IMU, loop_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers IMU_message_members = {
  ...
  "IMU",  // message name
  5,  // number of fields
  sizeof(snapstack_msgs2::msg::IMU),
...
{
  return &::snapstack_msgs2::msg::rosidl_typesupport_introspection_cpp::IMU_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, snapstack_msgs2, msg, IMU)() {
  return &::snapstack_msgs2::msg::rosidl_typesupport_introspection_cpp::IMU_message_type_support_handle;
}
