...
class Init_PolyhedronArray_lifetime
{
public:
  explicit Init_PolyhedronArray_lifetime(::decomp_ros_msgs::msg::PolyhedronArray & msg)
  : msg_(msg)
  {}
  ::decomp_ros_msgs::msg::PolyhedronArray lifetime(::decomp_ros_msgs::msg::PolyhedronArray::_lifetime_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_PolyhedronArray_lifetime polyhedrons(::decomp_ros_msgs::msg::PolyhedronArray::_polyhedrons_type arg)
  {
    msg_.polyhedrons = std::move(arg);
    return Init_PolyhedronArray_lifetime(msg_);
  }
