...
static rosidl_typesupport_introspection_c__MessageMember decomp_ros_msgs__msg__PolyhedronArray__rosidl_typesupport_introspection_c__PolyhedronArray_message_member_array[3] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(decomp_ros_msgs__msg__PolyhedronArray, lifetime),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, decomp_ros_msgs, msg, PolyhedronArray)() {
  ...
  decomp_ros_msgs__msg__PolyhedronArray__rosidl_typesupport_introspection_c__PolyhedronArray_message_member_array[2].members_ =
