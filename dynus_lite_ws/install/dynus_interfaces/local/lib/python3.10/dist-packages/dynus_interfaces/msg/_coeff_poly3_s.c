...
bool dynus_interfaces__msg__coeff_poly3__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynus_interfaces.msg._coeff_poly3.CoeffPoly3", full_classname_dest, 44) == 0);
  }
  dynus_interfaces__msg__CoeffPoly3 * ros_message = _ros_message;
  {  // a
...
{
  /* NOTE(esteve): Call constructor of CoeffPoly3 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynus_interfaces.msg._coeff_poly3");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CoeffPoly3");
