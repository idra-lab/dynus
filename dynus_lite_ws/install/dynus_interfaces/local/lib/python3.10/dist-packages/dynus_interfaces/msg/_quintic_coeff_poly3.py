...
class Metaclass_QuinticCoeffPoly3(type):
    """Metaclass of message 'QuinticCoeffPoly3'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__quintic_coeff_poly3
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__quintic_coeff_poly3
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__quintic_coeff_poly3
            cls._TYPE_SUPPORT = module.type_support_msg__msg__quintic_coeff_poly3
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__quintic_coeff_poly3
...
class QuinticCoeffPoly3(metaclass=Metaclass_QuinticCoeffPoly3):
    """Message class 'QuinticCoeffPoly3'."""
