...
class Metaclass_Mode(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'DYNUS': cls.__constants['DYNUS'],
        }

    @property
    def OTHER(self):
        """Message constant 'OTHER'."""
        return Metaclass_Mode.__constants['OTHER']

    @property
    def DYNUS(self):
        """Message constant 'DYNUS'."""
        return Metaclass_Mode.__constants['DYNUS']
