...
class Metaclass_CoeffPoly3(type):
    """Metaclass of message 'CoeffPoly3'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__coeff_poly3
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__coeff_poly3
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__coeff_poly3
            cls._TYPE_SUPPORT = module.type_support_msg__msg__coeff_poly3
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__coeff_poly3
...
class CoeffPoly3(metaclass=Metaclass_CoeffPoly3):
    """Message class 'CoeffPoly3'."""
