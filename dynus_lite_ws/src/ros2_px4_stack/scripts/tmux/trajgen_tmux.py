...
if __name__ == "__main__":
    ...
    commands = [
        ...
        f"{source_cmd} && sleep 10 && ros2 launch livox_ros_driver2 run_MID360_launch.py namespace:={veh}", # Pane 5
        f"{source_cmd} && sleep 10 && ros2 launch direct_lidar_inertial_odometry dlio.launch.py namespace:={veh}", # Pane 6
