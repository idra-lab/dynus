...
#include "decomp_ros_msgs/msg/detail/polyhedron__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = decomp_ros_msgs::msg::Polyhedron;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const decomp_ros_msgs::msg::Polyhedron *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<decomp_ros_msgs::msg::Polyhedron *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Polyhedron__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const decomp_ros_msgs::msg::Polyhedron *>(
...
static size_t _Polyhedron__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Polyhedron(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Polyhedron__callbacks = {
  "decomp_ros_msgs::msg",
  "Polyhedron",
...
static rosidl_message_type_support_t _Polyhedron__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Polyhedron__callbacks,
...
{
  return &decomp_ros_msgs::msg::typesupport_fastrtps_cpp::_Polyhedron__handle;
}
