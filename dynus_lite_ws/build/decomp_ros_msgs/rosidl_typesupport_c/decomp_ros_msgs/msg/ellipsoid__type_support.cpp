...
static const _Ellipsoid_type_support_symbol_names_t _Ellipsoid_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, decomp_ros_msgs, msg, Ellipsoid)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, decomp_ros_msgs, msg, Ellipsoid)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, decomp_ros_msgs, msg, Ellipsoid)() {
  return &::decomp_ros_msgs::msg::rosidl_typesupport_c::Ellipsoid_message_type_support_handle;
}
