...
{
  new (message_memory) dynus_interfaces::msg::Mode(_init);
}

void Mode_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dynus_interfaces::msg::Mode *>(message_memory);
  typed_message->~Mode();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Mode_message_member_array[2] = {
  {
    ...
    offsetof(dynus_interfaces::msg::Mode, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dynus_interfaces::msg::Mode, mode),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Mode_message_members = {
  ...
  "Mode",  // message name
  2,  // number of fields
  sizeof(dynus_interfaces::msg::Mode),
...
get_message_type_support_handle<dynus_interfaces::msg::Mode>()
{
  return &::dynus_interfaces::msg::rosidl_typesupport_introspection_cpp::Mode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynus_interfaces, msg, Mode)() {
  return &::dynus_interfaces::msg::rosidl_typesupport_introspection_cpp::Mode_message_type_support_handle;
}
