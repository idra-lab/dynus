...
static const _QuinticPWPTraj_type_support_symbol_names_t _QuinticPWPTraj_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynus_interfaces, msg, QuinticPWPTraj)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynus_interfaces, msg, QuinticPWPTraj)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dynus_interfaces, msg, QuinticPWPTraj)() {
  return &::dynus_interfaces::msg::rosidl_typesupport_c::QuinticPWPTraj_message_type_support_handle;
}
