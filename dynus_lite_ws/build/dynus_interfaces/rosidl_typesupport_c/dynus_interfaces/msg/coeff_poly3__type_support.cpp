...
static const _CoeffPoly3_type_support_symbol_names_t _CoeffPoly3_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynus_interfaces, msg, CoeffPoly3)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynus_interfaces, msg, CoeffPoly3)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dynus_interfaces, msg, CoeffPoly3)() {
  return &::dynus_interfaces::msg::rosidl_typesupport_c::CoeffPoly3_message_type_support_handle;
}
