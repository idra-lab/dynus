...
static const _QuinticCoeffPoly3_type_support_symbol_names_t _QuinticCoeffPoly3_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynus_interfaces, msg, QuinticCoeffPoly3)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynus_interfaces, msg, QuinticCoeffPoly3)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dynus_interfaces, msg, QuinticCoeffPoly3)() {
  return &::dynus_interfaces::msg::rosidl_typesupport_c::QuinticCoeffPoly3_message_type_support_handle;
}
