...
bool dynus_interfaces__msg__quintic_coeff_poly3__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynus_interfaces.msg._quintic_coeff_poly3.QuinticCoeffPoly3", full_classname_dest, 59) == 0);
  }
  dynus_interfaces__msg__QuinticCoeffPoly3 * ros_message = _ros_message;
  {  // a
...
{
  /* NOTE(esteve): Call constructor of QuinticCoeffPoly3 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynus_interfaces.msg._quintic_coeff_poly3");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "QuinticCoeffPoly3");
