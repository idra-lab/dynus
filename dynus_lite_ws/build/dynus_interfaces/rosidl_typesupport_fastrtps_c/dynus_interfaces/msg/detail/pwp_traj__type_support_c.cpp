...
#include "dynus_interfaces/msg/detail/pwp_traj__rosidl_typesupport_fastrtps_c.h"
...
#include "dynus_interfaces/msg/detail/coeff_poly3__functions.h"  // coeff_x, coeff_y, coeff_z
...
size_t get_serialized_size_dynus_interfaces__msg__CoeffPoly3(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_dynus_interfaces__msg__CoeffPoly3(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynus_interfaces, msg, CoeffPoly3)();


using _PWPTraj__ros_msg_type = dynus_interfaces__msg__PWPTraj;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PWPTraj__ros_msg_type * ros_message = static_cast<const _PWPTraj__ros_msg_type *>(untyped_ros_message);
  // Field name: times
  {
  ...
  // Field name: coeff_x
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, dynus_interfaces, msg, CoeffPoly3
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _PWPTraj__ros_msg_type * ros_message = static_cast<_PWPTraj__ros_msg_type *>(untyped_ros_message);
  // Field name: times
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
  ...
  // Field name: coeff_x
  {
    ...
    if (ros_message->coeff_x.data) {
      dynus_interfaces__msg__CoeffPoly3__Sequence__fini(&ros_message->coeff_x);
    }
  ...
  // Field name: coeff_y
  {
    ...
    if (ros_message->coeff_y.data) {
      dynus_interfaces__msg__CoeffPoly3__Sequence__fini(&ros_message->coeff_y);
    }
  ...
  // Field name: coeff_z
  {
    ...
    if (ros_message->coeff_z.data) {
      dynus_interfaces__msg__CoeffPoly3__Sequence__fini(&ros_message->coeff_z);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name coeff_x
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_dynus_interfaces__msg__CoeffPoly3(
...
static uint32_t _PWPTraj__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dynus_interfaces__msg__PWPTraj(
  ...
  size_t current_alignment)
{
  ...
  // member: coeff_x
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_dynus_interfaces__msg__CoeffPoly3(
  ...
  if (is_plain) {
    ...
    using DataType = dynus_interfaces__msg__PWPTraj;
    is_plain =
      (
...
static size_t _PWPTraj__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dynus_interfaces__msg__PWPTraj(
...
static message_type_support_callbacks_t __callbacks_PWPTraj = {
...
static rosidl_message_type_support_t _PWPTraj__type_support = {
