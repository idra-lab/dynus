...
#include "dynus_interfaces/msg/detail/goal__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // a, j, p, v
...
using _Goal__ros_msg_type = dynus_interfaces__msg__Goal;
...
size_t get_serialized_size_dynus_interfaces__msg__Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Goal__ros_msg_type * ros_message = static_cast<const _Goal__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dynus_interfaces__msg__Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dynus_interfaces
size_t max_serialized_size_dynus_interfaces__msg__Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynus_interfaces__msg__Goal;
    is_plain =
      (
...
static size_t _Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dynus_interfaces__msg__Goal(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynus_interfaces, msg, Goal)() {
