...
#include "dynus_interfaces/msg/detail/goal__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynus_interfaces::msg::Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dynus_interfaces::msg::Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynus_interfaces::msg::Goal *>(
    untyped_ros_message);
...
{
  return &dynus_interfaces::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
