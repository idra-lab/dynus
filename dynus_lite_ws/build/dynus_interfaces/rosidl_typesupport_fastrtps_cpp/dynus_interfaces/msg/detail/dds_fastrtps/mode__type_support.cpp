...
#include "dynus_interfaces/msg/detail/mode__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynus_interfaces::msg::Mode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dynus_interfaces::msg::Mode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynus_interfaces::msg::Mode *>(
    untyped_ros_message);
...
{
  return &dynus_interfaces::msg::typesupport_fastrtps_cpp::_Mode__handle;
}
