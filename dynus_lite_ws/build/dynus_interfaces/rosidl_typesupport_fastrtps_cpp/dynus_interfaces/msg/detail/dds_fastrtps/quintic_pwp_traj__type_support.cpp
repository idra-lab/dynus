...
#include "dynus_interfaces/msg/detail/quintic_pwp_traj__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const dynus_interfaces::msg::QuinticCoeffPoly3 &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  dynus_interfaces::msg::QuinticCoeffPoly3 &);
size_t get_serialized_size(
  const dynus_interfaces::msg::QuinticCoeffPoly3 &,
  size_t current_alignment);
size_t
max_serialized_size_QuinticCoeffPoly3(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
// functions for dynus_interfaces::msg::QuinticCoeffPoly3 already declared above
...
cdr_serialize(
  const dynus_interfaces::msg::QuinticPWPTraj & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynus_interfaces::msg::QuinticPWPTraj & ros_message)
{
  // Member: times
  {
    cdr >> ros_message.times;
  ...
  size_t current_alignment)
{
  ...
  // Member: coeff_x
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dynus_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_QuinticCoeffPoly3(
  ...
  if (is_plain) {
    ...
    using DataType = dynus_interfaces::msg::QuinticPWPTraj;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dynus_interfaces::msg::QuinticPWPTraj *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynus_interfaces::msg::QuinticPWPTraj *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _QuinticPWPTraj__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dynus_interfaces::msg::QuinticPWPTraj *>(
...
static size_t _QuinticPWPTraj__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_QuinticPWPTraj(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _QuinticPWPTraj__callbacks = {
...
static rosidl_message_type_support_t _QuinticPWPTraj__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_QuinticPWPTraj__callbacks,
...
{
  return &dynus_interfaces::msg::typesupport_fastrtps_cpp::_QuinticPWPTraj__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynus_interfaces, msg, QuinticPWPTraj)() {
  return &dynus_interfaces::msg::typesupport_fastrtps_cpp::_QuinticPWPTraj__handle;
}
