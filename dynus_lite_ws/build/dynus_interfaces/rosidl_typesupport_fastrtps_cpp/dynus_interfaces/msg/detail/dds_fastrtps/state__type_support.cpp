...
#include "dynus_interfaces/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dynus_interfaces::msg::State & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynus_interfaces::msg::State & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynus_interfaces::msg::State;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dynus_interfaces::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynus_interfaces::msg::State *>(
    untyped_ros_message);
...
{
  return &dynus_interfaces::msg::typesupport_fastrtps_cpp::_State__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynus_interfaces, msg, State)() {
  return &dynus_interfaces::msg::typesupport_fastrtps_cpp::_State__handle;
}
