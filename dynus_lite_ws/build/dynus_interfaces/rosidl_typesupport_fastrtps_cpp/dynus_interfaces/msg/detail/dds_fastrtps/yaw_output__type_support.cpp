...
#include "dynus_interfaces/msg/detail/yaw_output__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dynus_interfaces::msg::YawOutput & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.control_points;
  }
  // Member: knots
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynus_interfaces::msg::YawOutput & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: control_points
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.control_points[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: knots
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynus_interfaces::msg::YawOutput;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dynus_interfaces::msg::YawOutput *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynus_interfaces::msg::YawOutput *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _YawOutput__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dynus_interfaces::msg::YawOutput *>(
...
static size_t _YawOutput__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_YawOutput(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _YawOutput__callbacks = {
...
static rosidl_message_type_support_t _YawOutput__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_YawOutput__callbacks,
...
{
  return &dynus_interfaces::msg::typesupport_fastrtps_cpp::_YawOutput__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynus_interfaces, msg, YawOutput)() {
  return &dynus_interfaces::msg::typesupport_fastrtps_cpp::_YawOutput__handle;
}
