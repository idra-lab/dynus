...
#include "snapstack_msgs2/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const snapstack_msgs2::msg::State & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  snapstack_msgs2::msg::State & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = snapstack_msgs2::msg::State;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const snapstack_msgs2::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<snapstack_msgs2::msg::State *>(
    untyped_ros_message);
...
{
  return &snapstack_msgs2::msg::typesupport_fastrtps_cpp::_State__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, snapstack_msgs2, msg, State)() {
  return &snapstack_msgs2::msg::typesupport_fastrtps_cpp::_State__handle;
}
