...
#ifndef SNAPSTACK_MSGS2__MSG__DETAIL__GOAL__STRUCT_H_
#define SNAPSTACK_MSGS2__MSG__DETAIL__GOAL__STRUCT_H_
...
enum
{
  snapstack_msgs2__msg__Goal__MODE_POSITION_CONTROL = 0
};

/// Constant 'MODE_VELOCITY_CONTROL'.
enum
{
  snapstack_msgs2__msg__Goal__MODE_VELOCITY_CONTROL = 1
};

/// Constant 'MODE_ACCELERATION_CONTROL'.
enum
{
  snapstack_msgs2__msg__Goal__MODE_ACCELERATION_CONTROL = 2
};
...
// Struct for a sequence of snapstack_msgs2__msg__Goal.
typedef struct snapstack_msgs2__msg__Goal__Sequence
{
...
#endif  // SNAPSTACK_MSGS2__MSG__DETAIL__GOAL__STRUCT_H_
