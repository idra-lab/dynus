...
bool snapstack_msgs2__msg__attitude_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("snapstack_msgs2.msg._attitude_command.AttitudeCommand", full_classname_dest, 53) == 0);
  }
  snapstack_msgs2__msg__AttitudeCommand * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of AttitudeCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("snapstack_msgs2.msg._attitude_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AttitudeCommand");
