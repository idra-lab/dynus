...
class State(metaclass=Metaclass_State):
    ...
    def __init__(self, **kwargs):
        ...
        from builtin_interfaces.msg import Time
        self.state_stamp = kwargs.get('state_stamp', Time())
        from geometry_msgs.msg import Point
        ...
        from geometry_msgs.msg import Vector3
        self.abias = kwargs.get('abias', Vector3())
        from geometry_msgs.msg import Vector3
        self.gbias = kwargs.get('gbias', Vector3())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.state_stamp != other.state_stamp:
            return False
        ...
        if self.w != other.w:
            return False
        if self.abias != other.abias:
            return False
        if self.gbias != other.gbias:
            return False
        return True
    ...
    def state_stamp(self):
        """Message field 'state_stamp'."""
        return self._state_stamp

    @state_stamp.setter
    def state_stamp(self, value):
        if __debug__:
            from builtin_interfaces.msg import Time
            assert \
                isinstance(value, Time), \
                "The 'state_stamp' field must be a sub message of type 'Time'"
        self._state_stamp = value
    ...
    @abias.setter
    def abias(self, value):
        if __debug__:
            from geometry_msgs.msg import Vector3
            assert \
                isinstance(value, Vector3), \
                "The 'abias' field must be a sub message of type 'Vector3'"
        self._abias = value
    ...
    @gbias.setter
    def gbias(self, value):
        if __debug__:
            from geometry_msgs.msg import Vector3
            assert \
                isinstance(value, Vector3), \
                "The 'gbias' field must be a sub message of type 'Vector3'"
        self._gbias = value
