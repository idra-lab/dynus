...
bool snapstack_msgs2__msg__imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("snapstack_msgs2.msg._imu.IMU", full_classname_dest, 28) == 0);
  }
  snapstack_msgs2__msg__IMU * ros_message = _ros_message;
  {  // header
  ...
  {  // imu_stamp
    PyObject * field = PyObject_GetAttrString(_pymsg, "imu_stamp");
    if (!field) {
      return false;
    }
    if (!builtin_interfaces__msg__time__convert_from_py(field, &ros_message->imu_stamp)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // loop_time
    ...
    ros_message->loop_time = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * snapstack_msgs2__msg__imu__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("snapstack_msgs2.msg._imu");
  ...
  {  // imu_stamp
    PyObject * field = NULL;
    field = builtin_interfaces__msg__time__convert_to_py(&ros_message->imu_stamp);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "imu_stamp", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // loop_time
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->loop_time);
    {
