...
static const _CommAge_type_support_symbol_names_t _CommAge_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, snapstack_msgs2, msg, CommAge)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, snapstack_msgs2, msg, CommAge)),
  }
};
...
{
  return &::snapstack_msgs2::msg::rosidl_typesupport_cpp::CommAge_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, snapstack_msgs2, msg, CommAge)() {
  return get_message_type_support_handle<snapstack_msgs2::msg::CommAge>();
}
