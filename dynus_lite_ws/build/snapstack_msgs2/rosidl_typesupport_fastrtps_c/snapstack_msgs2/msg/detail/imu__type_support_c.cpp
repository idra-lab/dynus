...
#include "snapstack_msgs2/msg/detail/imu__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/detail/time__functions.h"  // imu_stamp
...
using _IMU__ros_msg_type = snapstack_msgs2__msg__IMU;
...
size_t get_serialized_size_snapstack_msgs2__msg__IMU(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _IMU__ros_msg_type * ros_message = static_cast<const _IMU__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _IMU__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_snapstack_msgs2__msg__IMU(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_snapstack_msgs2
size_t max_serialized_size_snapstack_msgs2__msg__IMU(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = snapstack_msgs2__msg__IMU;
    is_plain =
      (
...
static size_t _IMU__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_snapstack_msgs2__msg__IMU(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, snapstack_msgs2, msg, IMU)() {
