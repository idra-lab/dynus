...
#include "snapstack_msgs2/msg/detail/attitude_command__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // f_w, w
...
using _AttitudeCommand__ros_msg_type = snapstack_msgs2__msg__AttitudeCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AttitudeCommand__ros_msg_type * ros_message = static_cast<const _AttitudeCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AttitudeCommand__ros_msg_type * ros_message = static_cast<_AttitudeCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_snapstack_msgs2__msg__AttitudeCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AttitudeCommand__ros_msg_type * ros_message = static_cast<const _AttitudeCommand__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _AttitudeCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_snapstack_msgs2__msg__AttitudeCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_snapstack_msgs2
size_t max_serialized_size_snapstack_msgs2__msg__AttitudeCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = snapstack_msgs2__msg__AttitudeCommand;
    is_plain =
      (
...
static size_t _AttitudeCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_snapstack_msgs2__msg__AttitudeCommand(
...
static message_type_support_callbacks_t __callbacks_AttitudeCommand = {
  "snapstack_msgs2::msg",
  "AttitudeCommand",
...
static rosidl_message_type_support_t _AttitudeCommand__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AttitudeCommand,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, snapstack_msgs2, msg, AttitudeCommand)() {
  return &_AttitudeCommand__type_support;
}
